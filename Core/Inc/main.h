...
#define RF_D0_Pin GPIO_PIN_15
#define RF_D0_GPIO_Port GPIOC
#define HEART_BEAT_Pin GPIO_PIN_3
#define HEART_BEAT_GPIO_Port GPIOA
#define LEVEL1_Pin GPIO_PIN_4
#define LEVEL1_GPIO_Port GPIOA
#define LEVEL2_Pin GPIO_PIN_5
#define LEVEL2_GPIO_Port GPIOA
#define LEVEL3_Pin GPIO_PIN_6
#define LEVEL3_GPIO_Port GPIOA
#define LEVEL4_Pin GPIO_PIN_7
#define LEVEL4_GPIO_Port GPIOA
#define COMMON_CONTROL_Pin GPIO_PIN_0
#define COMMON_CONTROL_GPIO_Port GPIOB
